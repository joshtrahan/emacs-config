...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (helm-projectile org-projectile projectile company-emacs-eclim company-shell company helm-pydoc magit helm htmlize monokai-theme lua-mode multiple-cursors)))
 '(tab-stop-list
   (quote
